	...
	, qnode(argc,argv)
{
    ...
    **********************/
    ...
    QObject::connect(ui.operator_comboBox, SIGNAL(currentIndexChanged(int)), this, SLOT(changeOperator()));
...
void MainWindow::on_actionAbout_triggered() {
    QMessageBox::about(this, tr("About ..."),tr("<h2>oroca_ros_tutorials_gui</h2><p>Darby Lim(Taehoon Lim)</p>"));
}
